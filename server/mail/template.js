module.exports = function (keyboardNumber) {
  return [
    ...
    '<h1 class="size-28" style="font-style: normal;font-weight: 700;Margin-bottom: 0;Margin-top: 0;font-size: 24px;line-height: 36px;font-family: sans-serif;color: #cf61cf;"><span style="color:#fbfbfb">알람을 등록한 키보드가 입고되었습니다.</span></h1>',
    ...
    `<span style="color:#ffffff">제품 번호 : ${keyboardNumber} 😁</span></p>`,
    '<span style="color:#ffffff">해당 알람은 자동 삭제됩니다.</span></p>',
